...
('Unilever',
'Unilever is a British-Dutch transnational consumer goods company. Its products include food and beverages (about 40% of its revenue), cleaning agents and personal care products. It is the world\''s largest consumer goods company, one of the oldest multinational companies, and its products are available in around 190 countries. Unilever is organized into four main divisions – Foods, Refreshments (beverages and ice cream), Home Care, and Personal Care. In 2015, the company started gradually shifting its focus towards health and beauty brands and away from food brands showing slow growth',
'Consumer goods',
...
('Kellogg''s',
'Kellogg''s, doing business as The Kellogg Company, is an American multinational food-manufacturing company. Kellogg''s produces cereal and convenience foods, including cookies, crackers, and toaster pastries and markets its products by several well-known brands including Corn Flakes, Keebler, and Cheez-It. Kellogg''s mission statement is Nourishing families so they can flourish and thrive. Kellogg''s holds a Royal Warrant from Queen Elizabeth II and the Prince of Wales.',
'Food processing',
